...
struct Settings {
    ...
    Settings(const std::string& config_path,
        ...
        init_p_acceptance   (iestaade::from_json<double>        (config_path, key_prefix + "/init_p_acceptance")),
        init_t_candidates_n (iestaade::from_json<size_t>        (config_path, key_prefix + "/init_t_candidates_n")),
        init_t_max_attempts (iestaade::from_json<size_t>        (config_path, key_prefix + "/init_t_max_attempts")),
        cooling_rate        (iestaade::from_json<double>        (config_path, key_prefix + "/cooling_rate")),
        cooling_round_len   (iestaade::from_json<size_t>        (config_path, key_prefix + "/cooling_round_len")),
        e_decision_period   (iestaade::from_json<size_t>        (config_path, key_prefix + "/e_decision_period")),
        e_sma_fast_len      (iestaade::from_json<size_t>        (config_path, key_prefix + "/e_sma_fast_len")),
        e_sma_slow_len      (iestaade::from_json<size_t>        (config_path, key_prefix + "/e_sma_slow_len")),
        e_window            (iestaade::from_json<size_t>        (config_path, key_prefix + "/e_window")),
        e_shift             (iestaade::from_json<size_t>        (config_path, key_prefix + "/e_shift")),
        e_min_az_overlap    (iestaade::from_json<double>        (config_path, key_prefix + "/e_min_az_overlap")),
        ...
        n_records           (iestaade::from_json<size_t>        (config_path, key_prefix + "/n_records", true, 0)),
